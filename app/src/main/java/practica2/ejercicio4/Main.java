...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        persona1.setCi("345234").setNombre("Sergio");
        persona2.setCi("269593").setNombre("Fernando");
        persona3.setCi("893483").setNombre("Peter");
        persona4.setCi("846534").setNombre("Nadia");
        persona5.setCi("84234153").setNombre("Shurle");
        persona6.setCi("8432183").setNombre("Marco");
        persona7.setCi("2185486").setNombre("Ambar");
        persona8.setCi("82186384").setNombre("Ander");
        persona9.setCi("1218756").setNombre("Enrique");
        persona10.setCi("845435").setNombre("Miguel");
